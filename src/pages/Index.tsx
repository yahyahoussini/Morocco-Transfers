...
import { MapPin, Clock, Car, User, Phone, ChevronRight, Check, CalendarIcon, LocateFixed, Loader2, MessageCircle, Mail } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-background pt-10">
      ...
      <section className="relative h-[50vh] min-h-[350px] flex items-center justify-center overflow-hidden">
        <img src={heroBg} alt="Luxury Mercedes transfer" className="absolute inset-0 w-full h-full object-cover" />
      ...
      <section className="relative py-20 overflow-hidden">
        <img src={casablancaBg} alt="Casablanca cityscape" className="absolute inset-0 w-full h-full object-cover" />
